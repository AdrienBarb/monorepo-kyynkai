  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="z-[1000] max-w-md">
        <DialogHeader>
          <DialogTitle className="text-primary font-rubik text-center">
            Buy more credits
          </DialogTitle>
        </DialogHeader>
        ...
        <h3 className="text-base text-primary mt-4 text-center">
          ...
          <div className="mt-4 space-y-3 flex justify-center w-full">
            <div className="bg-primary/20 p-4 rounded-lg border border-primary text-center w-full">
              ...
              <div className="flex items-center justify-center mb-2">
                <span className="font-bold text-primary font-rubik">
                  FIRST-TIME BUYER SPECIAL!
                </span>
              </div>
              <p className="text-sm text-primary/90 mb-3 font-karla">
                Get{' '}
                <span className="font-bold text-primary text-lg">80% OFF</span>{' '}
